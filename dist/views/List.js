...
const StyledListItem = styled_components_1.default.View `
  ...
  border-bottom-color: ${colors_1.Colors.foreground.systemGrey6};
`;
...
exports.List = ({ listStyle, children }) => {
    ...
    return (react_1.default.createElement(StyledListWrapper, null,
        react_1.default.createElement(react_native_1.FlatList, { data: listChildren, renderItem: ({ item, index }) => (react_1.default.createElement(StyledListItem, { last: index === listChildren.length - 1 },
