...
install_xcframework "${PODS_ROOT}/Flipper-DoubleConversion/Frameworks/double-conversion.xcframework" "double-conversion" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator"
